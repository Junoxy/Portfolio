...
const HomePage = ({theme}) => {
    ...
    return (
        ...
        <Box className='home-text-container'>
            ...
            <Avatar className='home-img' src="src\assets\swaglord.jpg" alt="Juno" sx={{width: '300px', height: '300px', display:{xs:'block', md:'none'}}}/>
            ...
            <Avatar className='home-img' src="src\assets\swaglord.jpg" alt="Juno" sx={{width: '400px', height: '400px', display:{xs:'none', md:'block'}}}/>
        </Box>
    )
} 
