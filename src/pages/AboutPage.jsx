	...
	return (
		...
		>
			...
			>
				...
				>
					<Typography sx={{ fontSize: '2.5rem', color: theme.text }}>Who am i?</Typography>
					<Divider sx={{ bgcolor: theme.text }} />
					<Typography sx={{ fontSize: '1.3rem', color: theme.text, my: '16px' }}>
					...
					<Box sx={{ display: 'flex', gap: '30px', textAlign: 'center' }}>
						<Typography sx={{ fontWeight: '600', fontSize: '1.5rem', color: theme.text, my: '16px' }}>
			...
			>
				...
				>
					<Typography sx={{ fontSize: '2.5rem', color: theme.text }}>My Goal</Typography>
					<Divider sx={{ bgcolor: theme.text }} />
					<Typography sx={{ fontSize: '1.3rem', color: theme.text, my: '16px' }}>
