...
const ContactPage = ({ theme }) => {
	...
	return (
		...
		>
			<Typography sx={{ fontSize: '34px', fontWeight: '600', color: theme.text, textAlign: 'center' }}>
				For any questions you may have
			</Typography>
			<Typography sx={{ fontSize: '54px', fontWeight: '600', color: theme.text, textAlign: 'center' }}>
				{' '}
				Lets have a talk!
			</Typography>
			<button
